...
export class FRWebsiteMAJComponent implements OnInit {
  ...
  ngOnInit(){
    this.Majs = [
      ...
      {id:10, date: "08/08/2026", titre: "Reprise du site", description:"Après avoir délaisser ce site pendant plus d'un an, il est temps d'y faire un peu de ménage !", image:"assets/MAJ9.png"},
    ]
  }
}